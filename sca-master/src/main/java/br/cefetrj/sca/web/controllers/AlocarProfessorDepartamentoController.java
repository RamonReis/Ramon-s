...
import br.cefetrj.sca.service.AlocarProfessorDepartamentoService;

@Controller
@RequestMapping("/alocacaoProfessorDepartamento")
public class AlocarProfessorDepartamentoController {

	@Autowired
	private AlocarProfessorDepartamentoService service;
